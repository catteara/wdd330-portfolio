...
export default class Hikes {
  constructor(elementId) {
    ...
    this.comments = new Comments('hike', 'someHikeName');
  }
  ...
  showOneHike(hikeName) {
    ...
    document.getElementById('addCommentButton').addEventListener('click', this.comments.addComment);
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <form>
          ...
          <textarea style="width: 300px; height: 200px" placeholder="Enter your comment" name="content"></textarea>
